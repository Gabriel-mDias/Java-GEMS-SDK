...
- [ ] T023 [mecânico/medium/alto] Criar consumer smoke 3.1.0; vermelho para quebra muda estado a `aguardando-decisao-major`.
- [ ] T024 [especializado/medium/médio] Atualizar README, `AI-CONSUMER-GUIDE.md`, `llms.txt`, `CLAUDE.md` e criar `RELEASE-NOTES-3.2.0.md`.
- [ ] T025 [mecânico/low/médio] Executar `mvn versions:set -DnewVersion=3.2.0 -DgenerateBackupPoms=false`; conferir 17 POMs/BOM.
- [ ] T026 [mecânico/high/alto] Executar mutações finais e `mvn -B clean install -DgenerateBackupPoms=false`, contagem >= 186.
